...
export interface ApiMedicineCategoryMedicineCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'medicine_categories';
  info: {
    displayName: 'MEDICINE_CATEGORIES';
    pluralName: 'medicine-categories';
    singularName: 'medicine-category';
  };
  options: {
  ...
  attributes: {
    ...
    ControlledSubstance: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMedicineMedicine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DosageForm: Schema.Attribute.Enumeration<['Tablet', 'Syrup']>;
    ...
    medicine_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::medicine-category.medicine-category'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    >;
    stock_inventories: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPurchaseOrderLinePurchaseOrderLine
  ...
  info: {
    displayName: 'PURCHASE_ORDER_LINES';
  ...
  attributes: {
    ...
    QuantityOrdered: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    ReceivedStatus: Schema.Attribute.Enumeration<
